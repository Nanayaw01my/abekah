        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <button className="flex items-center justify-center gap-2.5 py-3 px-4 rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 text-white">
          <blockquote className="text-xl font-medium leading-relaxed mb-4">
            &ldquo;Found my dream apartment in just 2 days. The verified listings gave me complete
            peace of mind.&rdquo;
          </blockquote>
