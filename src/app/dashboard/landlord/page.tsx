...
const stats = [
  { label: "Properties Listed", value: "3", icon: Building2, change: "+1", color: "bg-blue-100 text-blue-600" },
  ...
  { label: "Revenue (est.)", value: "$9,700", icon: DollarSign, change: "+12%", color: "bg-emerald-100 text-emerald-600" },
        ...
        <div className="max-w-5xl mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-500 text-sm">Welcome back, Michael</p>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm mb-8">
            ...
            <div className="divide-y divide-gray-100">
              {mockLandlordProperties.map((property) => (
                <div key={property._id} className="p-4 flex items-center gap-4">
                  <img
